...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link href="{{asset('assets/registration/vendors/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('assets/registration/css/style.css')}}" rel="stylesheet">
    <link href="{{asset('assets/registration/css/responsive.css')}}" rel="stylesheet">
...
<div class="body_wrapper frm-vh-md-100">
    <div class="header_top d-flex align-items-center justify-content-between">
        <a href="index.html" class="logo"><img src="{{asset('assets/registration/img/logo.png')}}" alt=""></a>
    ...
    <div class="formify_body formify_signup_fullwidth parallax-effect d-flex">
        <div class="formify_left_fullwidth frm-vh-md-100"
             data-bg-img="{{asset('assets/registration/img/background-bg-left.jpg')}}">
        </div>
            ...
            <div class="parallax_img">
                <div class="p_img one">
                    <img class="layer layer2" data-depth="0.5"
                         src="{{asset('assets/registration/img/parallax-img/polygon1.png')}}" alt="">
                </div>
                <div class="p_img two"><img class="layer layer2" data-depth="0.4"
                                            src="{{asset('assets/registration/img/parallax-img/polygon2.png')}}"
                                            alt=""></div>
                <div class="p_img three"><img class="layer layer2" data-depth="0.5"
                                              src="{{asset('assets/registration/img/parallax-img/polygon3.png')}}"
                                              alt=""></div>
                <div class="p_img four"><img class="layer layer2" data-depth="0.5"
                                             src="{{asset('assets/registration/img/parallax-img/polygon4.png')}}"
                                             alt=""></div>
                <div class="p_img five"><img class="layer layer2" data-depth="0.5"
                                             src="{{asset('assets/registration/img/parallax-img/polygon5.png')}}"
                                             alt=""></div>
                <div class="p_img six"><img class="layer layer2" data-depth="0.5"
                                            src="{{asset('assets/registration/img/parallax-img/polygon6.png')}}"
                                            alt=""></div>
            </div>
...
<script src="{{asset('assets/registration/js/jquery-3.4.1.min.js')}}"></script>
<!-- Option 1: Bootstrap Bundle with Popper -->
<script src="{{asset('assets/registration/vendors/bootstrap/js/popper.min.js')}}"></script>
<script src="{{asset('assets/registration/vendors/bootstrap/js/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/registration/js/parallax.js')}}"></script>
<script src="{{asset('assets/registration/js/jquery.parallax-scroll.js')}}"></script>
