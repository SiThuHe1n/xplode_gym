                ...
                <form action="{{ route('section.update',$data->id) }}" method="post">
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-4 m-5 p-5 shadow bg-white rounded">
                            ...
                            <input value="{{ $data->day }}" type="number" name="day" class="form-control @error('day') is-invalid @enderror">
                            @error('day')
                            ...
                            <input value="{{ $data->month }}" type="number" name="month" class="form-control @error('month') is-invalid @enderror">
                            @error('month')
                                <span class="error invalid-feedback">
                                    {{ $message }}
                                </span>
                            ...
                            <a href="{{route('section.list')}}" class="btn btn-warning"> Cancle </a>
                        </div>
                    </div>
