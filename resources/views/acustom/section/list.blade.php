...
<div class="content p-3">
    <div class="container-fluid">
        <a href="{{route('section.add')}}" class="btn btn-primary"> Add section</a>
            ...
            <table class="table table-borderless">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> @if($dat->month) {{$dat->month}} Months @endif @if($dat->day) {{$dat->day}} Days @endif </td>
                        <td> {{$dat->cost}} </td>
                        ...
                        <td>
                            <a href="{{route('section.edit',$dat->id)}}" class="btn btn-warning"> Edit </a>
                            <a href="{{route('section.delete',$dat->id)}}" class="btn btn-danger"> Delete </a>
